<?php
    ...
    $this->header('Hírlevél szerkesztése és küldése', null);
    echo '<div class="content-page">';

    if ( $this->TEST_SENT )
    {
	     $this->message('Teszt üzenet elküldve a(z) ' . $this->sm->user->email . ' címre.', 'success');
    }
    ...
    {
	$this->form->button('Mentés', 'save');
        $this->form->button('Mentés és teszt küldése', 'save-send-test');
        $this->form->button('Mentés és kiküldés megkezdése', 'save-send');
    }
    else
    {
        $this->form->button('Mentés újként és ugrás a szerkesztésre', 'save-as');
        //$this->form->button('Mentés újként és teszt küldése', 'save-as-send-test');
    }
